...
sudo tc qdisc add dev $s_adapter root netem delay 40ms 40ms distribution normal
sudo tc qdisc add dev $d_adapter root netem delay 40ms 40ms distribution normal
