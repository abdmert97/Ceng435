...
sudo tc qdisc add dev $s_adapter root netem delay $1ms $2ms distribution normal
sudo tc qdisc add dev $d_adapter root netem delay $1ms $2ms distribution normal
